                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="notification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php
$ret1=mysqli_query($con,"select ID,FullName from tbluser where Status=''");
...
{
            ?>
         <p>  <a class="dropdown-item" href="user-details.php?viewid=<?php echo $result['ID'];?>">  <i class="fa fa-check"></i>New Application Received from <?php echo $result['FullName'];?></a></p> 
<?php }} else {?>
    <a class="dropdown-item" href="view-regold-user.php">No New Application Received</a>
        <?php } ?>
...
<?php }} else {?>
    <a class="dropdown-item" href="view-regold-user.php">No New Enquiry Received</a>
        <?php } ?>
                                </span>
                            </a>
