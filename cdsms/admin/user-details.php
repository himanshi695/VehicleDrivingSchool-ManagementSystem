...
if (strlen($_SESSION['cdsmsaid']==0)) {
   ...
   if(isset($_POST['submit']))
  {
   ...
   $query.=mysqli_query($con,"update tbluser set Status='$status' where ID='$uid'");
    if ($query) {
...
<?php  }  ?> 
 ...
 <?php
 $cid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tbluser join tblpackages on tblpackages.ID=tbluser.PackID where tbluser.ID='$cid'");
$cnt=1;
